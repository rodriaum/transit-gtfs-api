...
namespace Tranzor.Migrations
{
    ...
    [Migration("20250809010612_PendingChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tranzor.Models.Gtfs.External.StopCity", b =>
                {
                    ...
                    b.HasIndex("StopId")
                        .HasDatabaseName("ix_stop_cities_stop_id");
            ...
            modelBuilder.Entity("Tranzor.Models.Gtfs.External.StopCity", b =>
                {
                    b.HasOne("Tranzor.Models.Stop", null)
                        .WithMany("StopCities")
                        .HasForeignKey("StopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_stop_cities_stops_stop_id");
                });

            modelBuilder.Entity("Tranzor.Models.Stop", b =>
                {
                    b.Navigation("StopCities");
                });
